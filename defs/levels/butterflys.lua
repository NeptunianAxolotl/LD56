local data = {
	...
	width = 1350,
	height = 900,
	description = "Ah butterflies, they wipe away the scent of ant (they have very powerful wings). But a more interesting feature of this house is the hallway, it seems to go on forever.\n\nThis cheese is important, see that it is not harmed.",
